...
const translations: Record<string, Record<Language, string>> = {
  ...
  'documents.client': { nl: 'Klant', en: 'Client' },
  'documents.amount': { nl: 'Bedrag', en: 'Amount' },
  'documents.status': { nl: 'Status', en: 'Status' },
  'documents.sent': { nl: 'Verzonden', en: 'Sent' },
  'documents.viewed': { nl: 'Bekeken', en: 'Viewed' },
  'documents.signed': { nl: 'Ondertekend', en: 'Signed' },
  'documents.paid': { nl: 'Betaald', en: 'Paid' },
  'documents.declined': { nl: 'Afgewezen', en: 'Declined' },
  'documents.link': { nl: 'Link', en: 'Link' },
  'documents.loading': { nl: 'Laden...', en: 'Loading...' },
  'documents.selected': { nl: 'geselecteerd', en: 'selected' },
  'documents.delete': { nl: 'Verwijderen', en: 'Delete' },
  'documents.deselect': { nl: 'Deselecteren', en: 'Deselect' },
  'documents.deleteConfirmTitle': { nl: 'Documenten verwijderen?', en: 'Delete documents?' },
  'documents.deleteConfirmDesc': { nl: 'Weet je zeker dat je {count} document{plural} wilt verwijderen? Dit kan niet ongedaan worden gemaakt.', en: 'Are you sure you want to delete {count} document{plural}? This cannot be undone.' },
  'documents.cancel': { nl: 'Annuleren', en: 'Cancel' },
  'documents.deleting': { nl: 'Bezig...', en: 'Deleting...' },
  'documents.typeQuote': { nl: 'Offerte', en: 'Quote' },
  'documents.typeInvoice': { nl: 'Factuur', en: 'Invoice' },
  'documents.typeProposal': { nl: 'Voorstel', en: 'Proposal' },
  'documents.typeContract': { nl: 'Contract', en: 'Contract' },
  'documents.typeDocument': { nl: 'Document', en: 'Document' },
